...
function pull_commit(){
    ...
    if [[ ${git_project} =~ ft8_lib|other_git_project ]]; then
        git_root="master"
    fi
...
declare KA9Q_FT8_GIT_URL="git@github.com:ka9q/ft8_lib.git"     ### Where to get that code
...
# Or, github may be accessible if change https to ssh git 
    "ft8_lib           ${KA9Q_FT8_COMMIT_CHECK-yes}     ${KA9Q_FT8_EABLED-yes}      build_ka9q_ft8      NONE                            ${KA9Q_FT8_GIT_URL-git@github.com:ka9q/ft8_lib.git}                      ${KA9Q_FT8_COMMIT-66f0b5cd70d2435184b54b29459bb15214120a2c}"
